...
for i in range(no_of_table):
    try:
        ...
        for item in list_cols :
            ...
            pre_query1 = "begin;alter table {} rename to {}_old;create table {} (like {}_old);end;".format(sub_table_name,sub_table_name,sub_table_name,redshift_table_main)
            print(pre_query1)
            post_query1 ="drop table if exists {}_old;".format(redshift_table_main)    
            datasink2 = glueContext.write_dynamic_frame.from_jdbc_conf(frame = new_df_1, catalog_connection = "prod_dynamo_db_redshift", connection_options = {"preactions":pre_query1,"dbtable":redshift_table_main, "database": "convosight_prod_dynamo_data","postactions":post_query1}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink1")
