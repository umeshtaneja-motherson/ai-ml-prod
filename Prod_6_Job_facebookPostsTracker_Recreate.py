...
for i in range(no_of_table):
    try:
        ...
        pre_query1 = "begin;alter table {} rename to {}_old;create table {} (like {}_old);end;".format(redshift_table_main,redshift_table_main,redshift_table_main,redshift_table_main)
        print(pre_query1)
        post_query1 ="drop table if exists {}_old;".format(redshift_table_main) 
        print(post_query1)
        datasink1 = glueContext.write_dynamic_frame.from_jdbc_conf(frame = new_df, catalog_connection = "prod_dynamo_db_redshift", connection_options = {"preactions":pre_query1,"dbtable":redshift_table_main, "database": "convosight_prod_dynamo_data","postactions":post_query1}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink1")
        ...
        for item in list_cols :
            ...
            pre_query2 = "begin;alter table {} rename to {}_old;create table {} (like {}_old);end;".format(sub_table_name,sub_table_name,sub_table_name,sub_table_name)
            print(pre_query2)
            post_query2 ="drop table if exists {}_old;".format(sub_table_name) 
            print(post_query2)
            datasink2 = glueContext.write_dynamic_frame.from_jdbc_conf(frame = new_df_1, catalog_connection = "prod_dynamo_db_redshift", connection_options = {"preactions":pre_query1,"dbtable":sub_table_name, "database": "convosight_prod_dynamo_data","postactions":post_query1}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink1")
...
month = now.month
day = now.day
columns = ["table_name","status","total_no_of_rows_count"]
...
s3_target = "s3://convosight-prod-redshift/status_report/6_Config_facebookPostsTracker//"
