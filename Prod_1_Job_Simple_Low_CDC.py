...
dfnew1 = pd.read_csv('s3://convosight-prod-redshift/config/1_Job_SL.csv')
...
dfnew1.to_csv ('s3://convosight-prod-redshift/config/1_Job_SL.csv', index = False, header=True)
s3_target = "s3://convosight-prod-redshift/status_report/1_Job_SL/"
