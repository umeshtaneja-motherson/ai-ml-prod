...
for i in range(no_of_table):
    try:
        ...
        print(pre_query1)
        pre_query11 = "DELETE FROM {} WHERE key_id in (SELECT key_id FROM bd_staging_table_5);".format(redshift_table_main,redshift_table_main)
       # post_query1 = "drop table bd_staging_table_5;"
      #  print(post_query1)#"postactions":post_query1
        ...
        for item in list_cols :
            ...
            #print(pre_query2)
            pre_query22 = "DELETE FROM {} WHERE key_id in (SELECT key_id FROM bd_staging_table_5);".format(sub_table_name,sub_table_name)
            #post_query2 = "drop table bd_staging_table_5;"
                
            #print(post_query2)#"postactions":post_query2
            #datasink_temp_subtable = glueContext.write_dynamic_frame.from_jdbc_conf(frame = temp_new_df, catalog_connection = "prod_dynamo_db_redshift", connection_options = {"preactions":pre_query2,"dbtable":"bd_staging_table_5", "database": "convosight_prod_dynamo_data"}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink_temp")# added
