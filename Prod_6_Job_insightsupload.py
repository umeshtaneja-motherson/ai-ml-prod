...
dfnew1 = pd.read_csv('s3://convosight-prod-redshift/config/6_Job_insightsupload.csv')
...
dfnew1.to_csv ('s3://convosight-prod-redshift/config/6_Job_insightsupload.csv', index = False, header=True)
s3_target = "s3://convosight-prod-redshift/status_report/6_Job_insightsupload/"
