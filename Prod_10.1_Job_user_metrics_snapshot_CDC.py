...
for i in range(no_of_table):
    try:
        ...
        dfirst = dfirst.withColumn('createddatetime', to_timestamp("user_createdatutc"))
        dfirst = dfirst.withColumn("createddatetime",unix_timestamp("createddatetime", "yyyy-MM-dd HH:mm:ss"))
        dfirst = dfirst.withColumn('updateddatetime', to_timestamp("user_updatedatutc"))            
        ...
        pre_query11 = "DELETE FROM {} WHERE key_id in (SELECT key_id FROM bd_staging_table_10);".format(redshift_table_main,redshift_table_main)#added
        ...
        for item in list_cols :
            ...
            #print(pre_query2)
            pre_query22 = "DELETE FROM {} WHERE key_id in (SELECT key_id FROM bd_staging_table_10);".format(sub_table_name,sub_table_name)#added
