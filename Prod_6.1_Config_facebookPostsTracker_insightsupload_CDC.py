...
dfnew1 = pd.read_csv('s3://convosight-prod-redshift/config/6_Job_facebookPostsTracker.csv')
...
for i in range(no_of_table):
    try:
        ...
        pre_query11 = "DELETE FROM {} WHERE key_id in (SELECT key_id FROM bd_staging_table_6);".format(redshift_table_main,redshift_table_main)
        post_query1 = "drop table bd_staging_table_6;" 
        ...
        datasink1 = glueContext.write_dynamic_frame.from_jdbc_conf(frame = new_df, catalog_connection = "prod_dynamo_db_redshift", connection_options = {"preactions":pre_query11,"dbtable":redshift_table_main, "database": "convosight_prod_dynamo_data","postactions":post_query1}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink1")
        ...
        for item in list_cols :
            ...
            print(pre_query2)
            pre_query22 = "DELETE FROM {} WHERE key_id in (SELECT key_id FROM bd_staging_table_6);".format(sub_table_name,sub_table_name)
            post_query2 = "drop table bd_staging_table_6;"   
            ...
            datasink_subtable = glueContext.write_dynamic_frame.from_jdbc_conf(frame = new_df_1, catalog_connection = "prod_dynamo_db_redshift", connection_options = {"preactions":pre_query22,"dbtable": sub_table_name, "database": "convosight_prod_dynamo_data","postactions":post_query2}, redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink2")
...
dfnew1.to_csv ('s3://convosight-prod-redshift/config/6_Job_facebookPostsTracker.csv', index = False, header=True)
s3_target = "s3://convosight-prod-redshift/status_report/6_Job_facebookPostsTracker/"
